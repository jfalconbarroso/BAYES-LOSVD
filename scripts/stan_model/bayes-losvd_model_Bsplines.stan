...
transformed data{
  ...
  for (ind in 1:num_basis)
    B[ind,:] = to_row_vector(build_b_spline(to_array_1d(knots), to_array_1d(ext_knots), ind, spline_degree + 1));
...
parameters {
  ...
  row_vector<lower=0.0,upper=10.0>[num_basis] a;        // B-splines coefficients
 
}
//=============================================================================
transformed parameters {

  vector<lower=0.0>[nvel] losvd_ =  to_vector(a*B);       // B-splines LOSVD
