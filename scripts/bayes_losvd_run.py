...
if (__name__ == '__main__'):
    ...
    parser.add_argument("-g", "--gh_fit",       action="store_true",             help="If set, run Gauss-Hermit fits")
    parser.add_argument("-k", "--l_moments",    action="store_true",             help="If set, run L-moments computation")
